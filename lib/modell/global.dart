...
Post post1 = new Post(
    new AssetImage('assets/images/photo_1.jpeg'),
    user,
    "My first post",
    DateTime.now(),
...
final User user = new User(
    ...
    [],
    false);
User follower1 = new User('the_rock',
    AssetImage('assets/images/follower3.jpeg'), [], [], [], [], true);
User follower2 = new User('miley_cyrus',
    AssetImage('assets/images/follower2.jpg'), [], [], [], [], false);
User follower3 = new User('kim_k',
    AssetImage('assets/images/their_profile.jpeg'), [], [], [], [], true);
User follower4 = new User('daredevil', AssetImage('assets/images/profile3.png'),
    [], [], [], [], true);
User follower5 = new User(
    'batman', AssetImage('assets/images/profile6.jpg'), [], [], [], [], true);
User follower6 = new User('peter_griffin',
    AssetImage('assets/images/profile4.png'), [], [], [], [], false);
List<Post> userPosts = [
  new Post(
      new AssetImage('assets/images/photo_1.jpeg'),
      user,
  ...
  new Post(
      ...
      false),
  new Post(
      new AssetImage('assets/images/photo4.jpg'),
      follower5,
      ...
      false),
  new Post(
      new AssetImage('assets/images/photo5.jpg'),
      follower3,
