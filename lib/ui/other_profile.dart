...
//import 'package:techstagram/constants3.dart';
//import 'package:techstagram/models/user.dart';
//
...
//
//  createButtonTitle(
//      {String title, Function performFunction, User userData}) {
//    return Container(
...
//
//  //unfollow user
//  controlUnfollowUser(User userData) {
//    databaseserver.followersReference
//        .document(widget.wiggle.email)
//        .collection('userFollowers')
...
//  }
//
//  saveReceivercloudforfollow(User userData) async {
...
//  }
//
//  saveReceivercloudforrequest(User userData) async {
//    QuerySnapshot query = await DatabaseService(uid: widget.wiggle.id)
//        .getReceivertoken(widget.wiggle.email);
//    String val = query.documents[0].data['token'].toString();
//    databaseserver.cloudReference.document().setData({
...
//  }
//
//  sendrequest(User userData) async {
//    print('request');
//    if (this.mounted) {
//      setState(() {
//        sentrequest = true;
...
//
//  //follow user
//  controlFollowUser(User userData) {
//    print('hi');
//    databaseserver.followersReference
//        .document(widget.wiggle.email)
//        .collection('userFollowers')
