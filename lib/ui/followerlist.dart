...
class FollowersList extends StatefulWidget {
  ...
  _FollowersList createState() => _FollowersList(
      displayNamecurrentUserX: displayNamecurrentUserX, uidX: uidX);
}
...
class _FollowersList extends State<FollowersList> {
  ...
  TextEditingController displayNameControllerO,
      uidControllerO,
      emailControllerO,
      photoUrlControllerO,
                            ...
                            child: Row(
                              children: <Widget>[
                                ...
                                MaterialButton(
                                  ...
                                  child: Row(
                                    children: [
                                      (photoUrlControllerO.text != null)
                                          ? CircleAvatar(
                                              radius: 20,
                                              backgroundImage: NetworkImage(
                                                  photoUrlControllerO.text),
                                              backgroundColor:
                                                  Colors.transparent,
                                            )
                                          : CircleAvatar(
